...
@AuditedObject
@ObjectDefinition(resourceKey = FileStreamedEvent.RESOURCE_KEY, scope = ObjectScope.GLOBAL, 
...
public class FileStreamedEvent extends TransferResultEvent {
	...
	public static final String RESOURCE_KEY = "fileStreamedEvent";
	
	public FileStreamedEvent() { }
	
	public FileStreamedEvent(TransferResult result) {
		super(result, RESOURCE_KEY);
	}
	
	public FileStreamedEvent(TransferResult result, Throwable e) {
