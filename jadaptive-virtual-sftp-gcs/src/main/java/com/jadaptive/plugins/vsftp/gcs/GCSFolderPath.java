...
public class GCSFolderPath extends VirtualFolderPath {
	...
	@ObjectField(type = FieldType.TEXT, view =VirtualFolder.FOLDER_VIEW, weight = 100, bundle = GCSFolder.RESOURCE_KEY)
	String bucket;
	
	@ObjectField(type = FieldType.TEXT, view =VirtualFolder.FOLDER_VIEW, weight = 200, bundle = GCSFolder.RESOURCE_KEY)
	String filePath;
